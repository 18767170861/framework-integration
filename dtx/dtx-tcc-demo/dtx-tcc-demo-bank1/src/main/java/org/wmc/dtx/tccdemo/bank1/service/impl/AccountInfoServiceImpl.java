package org.wmc.dtx.tccdemo.bank1.service.impl;
...
import org.wmc.dtx.tccdemo.bank1.dao.AccountInfoDao;
import org.wmc.dtx.tccdemo.bank1.service.AccountInfoService;
import org.wmc.dtx.tccdemo.bank1.spring.Bank2Client;
...
public class AccountInfoServiceImpl implements AccountInfoService {
  ...
  public void commit(String accountNo, Double amount) {
    //获取全局事务id
    String transId = HmilyTransactionContextLocal.getInstance().get().getTransId();
    log.info("bank1 confirm begin 开始执行...xid:{},accountNo:{},amount:{}", transId, accountNo,
        amount);
  }


  /**
   * cancel方法 cancel幂等校验 cancel空回滚处理 增加可用余额
   *
   * @param accountNo
   * @param amount
   */
