...
import org.wmc.enums.SysConstant;
...
import org.wmc.service.IKillService;
import org.wmc.service.RabbitSenderService;
import org.wmc.utils.RandomUtil;
import org.wmc.utils.SnowFlake;
...
public class KillServiceImpl implements IKillService {
    ...
    public Boolean killItemV4(Integer killId, Integer userId) throws Exception {
        ...
        try {
            // 上锁以后10秒自动释放,无需调用unlock手动解锁
            //lock.lock(10, TimeUnit.SECONDS);
            // 尝试加锁，最多等待30秒，上锁以后10秒自动释放
